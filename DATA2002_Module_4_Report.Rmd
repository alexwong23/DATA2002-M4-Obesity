...
### changes by Katherine
significant variables that we have identified throughout research in order to build a simpler model to determine the odds of an individual being obesed.
...
$$\hat{BodyFat} = 1.52 -0.3965Neck - 0.128Chest$$
$$+ 1.01805Abdomen -0.28758Hip + 0.26Vicep -1.55084Wrist$$
